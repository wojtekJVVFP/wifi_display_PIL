...
devices.append(Ws_devices(ip='192.168.1.115', name='samsung note 9', greet='jestem note 9', isActive = True, resolution = (1440, 2990), dpi = 514))   #1
...
devices.append(Ws_devices(ip='192.168.1.103', name='Galaxy Tab S7', greet='Tab S7', isActive = False, resolution = (1752, 2800), dpi = 226))    #7